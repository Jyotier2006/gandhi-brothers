    ...
    <>
          ...
          <div className="animate-fade-up flex flex-wrap gap-4 justify-center" style={{ animationDelay: '300ms' }}>
            <Link href="/products">
              <Button size="lg" className="sheen rounded-full h-12 px-8 text-base shadow-lg shadow-terracotta/20 transition-transform duration-300 hover:-translate-y-0.5 active:translate-y-0">
                Shop the catalogue <ArrowRight className="ml-2 h-4 w-4 transition-transform duration-300 group-hover:translate-x-0.5" />
              </Button>
            </Link>
            <Link href="#heritage">
            ...
            {[
              ...
              <Reveal key={c.cat} delay={i * 90}>
                <Link
                  ...
                  className="group block rounded-2xl bg-cream hover:bg-terracotta/5
                             border border-ink/8 hover:border-terracotta/20
                             transition-all duration-300 overflow-hidden hover:shadow-lg hover:-translate-y-1"
                >
      ...
      <section className="py-16 md:py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <Reveal className="relative overflow-hidden rounded-3xl bg-terracotta text-white
                          px-8 py-10 md:px-12 md:py-14
                          grid grid-cols-1 md:grid-cols-2 gap-8 items-center shadow-xl shadow-terracotta/20">
            {/* decorative glow */}
            ...
            <div className="relative flex md:justify-end">
              <Link href="/products">
                <Button variant="accent" size="lg" className="sheen transition-transform duration-300 hover:-translate-y-0.5">Start shopping</Button>
              </Link>
            </div>
          </Reveal>
        </div>
